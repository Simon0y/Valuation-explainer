...
navy accent, green/red reserved strictly for positive/negative deltas, and the clean
sans-serif (Inter) typeface with tabular figures.
"""
...
# --------------------------------------------------------------------------------------
# Plotly styling — white surface, single navy accent, muted gridlines, sans-serif fonts
# --------------------------------------------------------------------------------------
